...
public class AsientosController {
     ...
     */
    private void actualizarSaldoEnBaseDeDatos(String nombreUsuario, double nuevoSaldo) {
        try {
            // Crear una instancia del DAO
            UsuarioDAOImpl usuarioDAO = new UsuarioDAOImpl();

            // Actualizar el saldo del usuario
            usuarioDAO.actualizarSaldo(nombreUsuario, nuevoSaldo);

            System.out.println("Saldo actualizado en la base de datos para " + nombreUsuario + ": " + nuevoSaldo);
        } catch (Exception e) {
     ...
     */
    public void configurarAsientos(String nombreUsuario, double dineroUsuario, String nombrePelicula, double precioPelicula, String horarioSeleccionado) {
        ...
        Label_NombreUsuario.setText("Usuario: " + nombreUsuario);
        Label_DineroUsuario.setText(String.format("Dinero: $%.2f", dineroUsuario));
